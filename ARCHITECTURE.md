...
- `runenui_runtime` — live mounted/semantic storage, reconciliation, routing, focus/input state, scheduling, style/text/layout orchestration, deterministic motion lifecycle/sampling, correlated visual/hit/focus/semantic geometry, visual/composition publication, tracing, publication, and shutdown.
