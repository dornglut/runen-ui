...
M0–M3, M4A, M4B, M4C0, and M4C1 are complete. M4C1 is
owner-accepted and squash-merged in PR #77. ADR 0005 remains routed-behavior
authority, ADR 0006 scheduler-behavior authority, the accepted
...
acceptance authority. M4C2 is queued after the governance and behavior-preserving
runtime/trace/surface decomposition gates; M4C3–M4C5 and M4D1–M4D3 remain blocked
in sequence. No surface-generation, pointer-capture, release-inside, focus-scope/
modality, keyboard/text/IME, authored automation resolution, semantic
accessibility mapping, export, sink, or replay maturity is upgraded. M4 is active
and incomplete. Volatile branch, head, blocker, and next-action state lives in the
