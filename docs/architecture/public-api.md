...
- clipboard/native IME/cursor/drop framework services, pointer selection, scrolling, touch/controller profiles, and integrated native/renderer closure (M10D–M10F);
