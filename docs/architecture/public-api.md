...
- transactional text editing sessions/intents/undo/editable semantics, clipboard/IME services, pointer selection, scrolling, and integrated native/renderer closure (M10C–M10F);
